  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Private landlords must have the fixed electrical installations inspected and tested at least every five years by a qualified person, or sooner if the latest report specifies an earlier date, and obtain an Electrical Installation Condition Report (EICR). Tenants must receive a copy within 28 days.",
          "If the report requires remedial work, you generally have 28 days (or sooner if specified) to complete it and confirm completion. Breaches can bring council penalties of up to £40,000.",
        ],
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Local authorities can impose financial penalties of up to £40,000 for breaches of the electrical safety regulations.",
      },
      {
