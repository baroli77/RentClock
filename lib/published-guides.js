...
async function loadPublishedGuides() {
  // Preview/CI builds intentionally run without production database secrets.
  // Static guides should still build; protected runtime pages fail separately.
...
const getCachedPublishedGuides = unstable_cache(loadPublishedGuides, ["published-guides"], {
  revalidate: 3600,
  tags: ["published-guides"],
});
