...
export default function FeatureLanding({ page }) {
  ...
  return <PublicChrome>
    ...
    <section className="home-v2-cta"><p className="eyebrow">Set it up once</p><h2>Know what is due before it becomes expensive.</h2><p>Start with a 14-day free trial. Card required; cancel before day 14 to pay nothing.</p><Link href="/login?trial=1" className="btn brass">Start free trial</Link></section>
  </PublicChrome>;
}
