...
export default function PublicChrome({ children, className = "", home = false }) {
  return <div className={`app public-site ${className}`.trim()}>
    <PublicHeader home={home} />
    <main>{children}</main>
    <footer className={`foot public-foot${home ? " home-v2-foot" : ""}`}>
